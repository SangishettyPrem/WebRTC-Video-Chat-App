...
const Options = ({ children }) => {
    const { me, name, setname, callEnded, leaveCall, callUser, callAccepted } = useContext(SocketContext)
                    ...
                    <Grid container className={classes.gridContainer}>
                        <Grid item xs={12} md={6} className={classes.padding}>
                            ...
                            <CopyToClipboard text={me} className={classes.margin}>
                                <Button variant='contained' color='primary' fullWidth startIcon={<Assignment fontSize='large' />} className={classes.margin} >
                                    Copy Your ID
                                </Button>
                            </CopyToClipboard>
                        </Grid>
